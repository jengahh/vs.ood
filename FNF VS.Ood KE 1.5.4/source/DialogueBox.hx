package;
//This Code From FNF HD And NEO Go Play THEM!
...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		else
		{
			...
			portraitBF = new Portrait(700, 145, "bf");
			add(portraitBF);
		...
		swagDialogue = new FlxTypeText(100, 560, Std.int(FlxG.width * 0.6), "", 32);
		...
		switch (curCharacter)
		{
			...
			case "bg":
				...
				switch(curAnim){
					...
					default:
						...
						cutsceneImage.loadGraphic(BitmapData.fromFile("assets/shared/images/BG/" + curAnim + ".png"));
				}
			case "sound":
				skipDialogue = true;
				if (this.sound != null) this.sound.stop();
			...
			case "music":
				...
				switch(curAnim){
					...
					default:
						FlxG.sound.playMusic(Sound.fromFile("assets/shared/images/BG/" + curAnim + ".ogg"), Std.parseFloat(dialogueList[0]));
				}
